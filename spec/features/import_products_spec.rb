...
describe 'Import products', type: :feature do
  ...
  it 'admin should be able to import products and delete import' do
    product_import = User.find(318).product_imports.create!(data_file: File.open('./spec/fixtures/valid.csv'), encoding_csv: "UTF-8", separatorChar: ",")
    SolidusImportProducts::Import.call(product_imports: product_import)
